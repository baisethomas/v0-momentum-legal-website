...
import { ArrowRight, Menu, X, Phone, Mail, Linkedin, Twitter, MapPin, Clock, CheckCircle, Check, Send } from "lucide-react"
        ...
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-12">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              <motion.div 
                className="px-6 py-2.5 text-sm font-medium transition-colors bg-black text-white"
              >
          ...
          {isMenuOpen && (
            ...
            >
              <div className="space-y-4">
                ...
                <button onClick={() => scrollToSection('services')} className="block w-full text-left text-sm font-normal text-gray-700 hover:text-black">Services</button>
                <div className="w-full mt-4 px-6 py-2.5 text-sm font-medium bg-black text-white text-center">
                  Schedule Consultation
                </div>
              </div>
            </motion.div>
      ...
      <footer className="py-16 bg-black text-white">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-12">
          ...
          <div className="border-t pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-light text-gray-500 border-gray-800">
            <p>© 2024 Momentum Legal. All rights reserved.</p>
